...
export function buildMamDesignSystemPrompt(input: {
  ...
  return [
    ...
    '- Every review_gate with maxRevisionAttempts greater than 1 and an upstream producing role_task must have a changes_requested return edge to that producer. Set maxTraversals to no more than that review_gate maxRevisionAttempts.',
