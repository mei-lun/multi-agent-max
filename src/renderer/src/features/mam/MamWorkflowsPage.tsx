...
export function MamWorkflowsPage({
  ...
  return (
    <section aria-labelledby="workflows-title" className="mx-auto w-full max-w-5xl space-y-6 p-6">
      ...
      {workflows.length === 0 ? (
        ...
        <div className="space-y-4">
          {workflows.map((workflow) => (
            <article key={workflow.id} className="overflow-hidden rounded-xl border border-border">
