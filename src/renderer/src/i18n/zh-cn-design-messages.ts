export const ZH_CN_DESIGN_MESSAGES: Readonly<Record<string, string>> = {
  ...
  'Waiting for your answers': '正在等待你的回答',
  'Waiting for your answer': '正在等待你的回答',
  'Waiting for an approach': '正在等待你选择方案',
  'Waiting for section approval': '正在等待分段认可',
  'Workflow review is open': '工作流仍有待处理问题',
